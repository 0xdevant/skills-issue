...
Before answering, you need both halves of their model:

1. what they think the answer is
2. which parts of that they have **verified** versus which they are **assuming**

Ask for whichever they have not given, and never for one they have. They commit first, which makes
fishing impossible. The verified/assumed split is the work itself: everything they have only
assumed is where the reasoning is load-bearing and untested.

When they have given neither, asking only for the second is the common slip: they report evidence
without ever committing to a conclusion.
